...
export default function DashboardAdmin() {
  ...
  const handleSalvarAula = async () => {
    if (!formData.modalidade || !formData.horario) {
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-bold text-[#6da67a]">{totalReservas}</span>
                    </div>
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-bold text-[#859987]">
                        {totalReservas > 0 ? Math.round((reservasCompareceu / totalReservas) * 100) : 0}%
                      </span>
                    </div>
                  </div>
                </div>
